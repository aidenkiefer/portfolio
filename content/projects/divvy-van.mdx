---
title: "Divvy Route Optimizer: TSP Algorithm with Real-Time Traffic Data"
slug: "divvy-van"
date: "2025-01-01"
featured: false
tags: ["Algorithms", "Greedy Algorithms", "Dynamic Programming", "Heuristics", "Frontend Architecture", "Third-Party API Integration", "State Management", "Performance Optimization (Web)", "Caching Strategies", "Error Handling", "Tradeoff Analysis", "Route Optimization", "TSP Algorithm", "React", "API Integration", "Real-time Data", "Google Maps", "Weather API", "Frontend Development"]
stack: ["React", "JavaScript", "Google Maps JavaScript API", "OpenWeather API", "Vite", "Tailwind CSS", "React Router DOM"]
repoUrl: ""
liveUrl: ""
