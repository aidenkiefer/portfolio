---
title: "Personal Portfolio: Next.js App Router with MDX & Search"
slug: "personal-portfolio-website"
date: "2025-01-01"
featured: true
tags: ["Software Architecture", "Web Architecture", "Frontend Architecture", "Static Site Generation (SSG)", "Performance Optimization (Web)", "SEO Fundamentals", "State Management", "Data Structures", "Searching", "Tradeoff Analysis", "Requirements Interpretation", "Technical Writing", "Documentation", "Maintainable Code", "Web Development", "Systems Design", "Content Strategy", "UI/UX Design", "SEO"]
