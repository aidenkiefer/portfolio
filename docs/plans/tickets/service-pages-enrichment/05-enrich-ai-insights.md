## 05 — Enrich service page: AI Insights (`/services/ai-insights`)

## Task

- Add the **eight enrichment sections** (per `docs/plans/specs/service-pages-enrichment-spec.md`) to the existing `/services/ai-insights` page.
...
- Content must be specific to AI-Based Business Insights and consistent with `docs/content/ai-insights.md`; use the global writing guidelines (non-technical founders first, outcomes, plain language).
...
- app/services/ai-insights/page.tsx
...
1. Use skills as above; read the enrichment spec and `docs/content/ai-insights.md` to understand the service and section requirements.
2. Open `app/services/ai-insights/page.tsx` and locate where existing content ends and the final CTA repeat begins.
...
- `/services/ai-insights` page contains all eight enrichment sections in the specified order, with the required headings.
- Existing sections (hero, problem/promise, deliverables, use cases, timeline, CTA repeat) are unchanged.
- Content is specific to AI Insights and consistent with `docs/content/ai-insights.md`.
- Only `app/services/ai-insights/page.tsx` was modified; changes are summarized in ≤5 bullets or an Implementation Summary.
